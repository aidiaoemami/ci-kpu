          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-users" aria-hidden="true"></i> Pemilih</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_pemilih') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
                    ...
                    <tr>
                      <?php if (is_array($list_users)) { ?>
                        <?php foreach ($list_users as $dd) : ?>
                          ...
                          <td><?= $dd->tanggal_lahir ?></td>
                          <td><?= $dd->alamat ?></td>
                          <td><?= $dd->agama ?></td>
                          <td><?= $dd->status_perkawinan ?></td>
                          <td><?= $dd->pekerjaan ?></td>
                          <td><?= $dd->kewarganegaraan ?></td>
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_user/' . $dd->nik) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/proses_delete_pemilih/' . $dd->nik) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                      <?php endforeach; ?>
                    <?php } else { ?>
