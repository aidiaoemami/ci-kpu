...
<head>
  ...
  <title>Si-Pemilu | Dashboard</title>
        ...
        <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url('admin/form_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tambah Barang Produksi</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url('admin/tabel_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tabel Barang Produksi</a></li>
            </ul>
          ...
          <!-- ./col -->
           <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              ...
              <a href="<?= base_url('admin/calon') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
