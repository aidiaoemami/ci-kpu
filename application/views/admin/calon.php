          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-users" aria-hidden="true"></i> Calon</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_calon') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
                    ...
                    <tr>
                      <?php if (is_array($list_users)) { ?>
                        <?php foreach ($list_users as $dd) : ?>
                          ...
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_calon/' . $dd->nik) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/proses_delete_calon/' . $dd->nik) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                      <?php endforeach; ?>
                    <?php } else { ?>
